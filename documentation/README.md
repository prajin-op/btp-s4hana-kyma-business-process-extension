...
1. [Discover](discover/README.md)
    ...
    1. [Understand the Database Service](discover/db-service/README.md)
    1. [Understand the Business Partner Service](discover/bp-service/README.md)
    1. [Understand the QRCode Generator](discover/qrcodegenerator/README.md)
    1. [Understand the Approuter](discover/approuter/README.md)
...
3. [Set Up](set-up/README.md)
    ...
    1. [Create an SAP HANA Cloud Instance](set-up/hana/README.md)
    1. [SAP S/4HANA Enable OData Service for Business Partner](set-up/s4h-setup/README.md)
    1. [Set Up Connectivity Between SAP S/4HANA System and SAP BTP](set-up/connectivity/README.md)
    1. [Configure Command Line Tool *kubectl*](set-up/kubeconfig-setup/README.md)
4. [Deploy](deploy/README.md)
    ...
    1. Optional [Setup Mock Server](deploy/setup-mock/README.md)
